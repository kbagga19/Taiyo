...
import WorldMap from "../components/MapCont";
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
        <h2 className="text-2xl text-white font-bold mb-4">
            <button className="shadow shadow-slate-700 bg-blue-600 p-3 text-2xl">
        ...
        <h2 className="text-xl text-white font-bold mb-4">
            <button className="shadow shadow-slate-700 bg-blue-600 p-3 text-xl" 

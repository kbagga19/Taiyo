...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-white p-4 w-full ">
            <div className="m-4">
                <button className="rounded-full shadow shadow-slate-700 font-bold bg-blue-600 p-3 text-2xl ml-96">
                    <Link to="/ContactForm">
                        Create Contact
                    </Link>
                </button>
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-blue-700 rounded-md shadow-xl m-4 p-5 text-center text-white">
                            <div onClick={() => togglePopup(el)} className="w-3/4 m-auto  ">
                                ...
                                <div className="p-4">
                                    {isOpen &&
                                        <Card close={() => togglePopup(data)} el={singleContact} />
                                    }
                                </div>    
